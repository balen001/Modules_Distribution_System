 ...
 * @author Balen
 */
public class showSubjectFrame extends javax.swing.JFrame {
    
    static String subjectDir = "./Subject.txt";  //file directory
    
    ArrayList <Subject> AllSubject = new ArrayList <Subject>(); // to put all instructor data into it
    String tableHeaders [] = new String[] {"Subject name", "Number of credits" , "Subject ID", "Program ID"};
     ...
     */
    public showSubjectFrame() {
        initComponents();
        
        
        
        // we should set the table model directly when the frame appears
        subjectModel = new DefaultTableModel(tableHeaders, 0);
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        DefaultTableModel tableModel = (DefaultTableModel) subjectTbl.getModel();
        
        if(foundIndex == -1){
        //to delete the row
        if (subjectTbl.getSelectedRowCount() == 1){
        
            // if only a single row selected perform delete
            
            int r = subjectTbl.getSelectedRow();
        ...
        else if (subjectTbl.getSelectedRowCount() == 0) {
        ...
        //to delete data after search
            ...
            // if only a single row selected perform delete
            int selectedRow = subjectTbl.getSelectedRow();
            
            tableModel.removeRow(selectedRow);
            AllSubject.remove(foundIndex);
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        ...
        try {
            FileOutputStream fileOutput = new FileOutputStream(subjectDir);
            ObjectOutputStream write = new ObjectOutputStream(fileOutput); 
		
            ArrayList <Subject> editedSubject = new ArrayList <Subject>();
            editedSubject = AllSubject;
            
            write.writeObject(editedSubject);
            write.close();
    ...
    private void searchBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBtnActionPerformed
        ...
        for(int j = 0; j < AllSubject.size(); j++){
                ...
                if(AllSubject.get(j).getSubjectID().equals(searchID)){
        ...
        Object[] info = {AllSubject.get(foundIndex).getSubjectName(), AllSubject.get(foundIndex).getNumberOfCredits() , AllSubject.get(foundIndex).getSubjectID() , AllSubject.get(foundIndex).getCourseID()};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(showSubjectFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new showSubjectFrame().setVisible(true);
            }
        });
    }
